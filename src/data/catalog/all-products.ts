...
const cephalopodProducts: CatalogProduct[] = [
  {
    ...
    sizes:        ["U/2", "U/1", "1/2", "2/4", "5/7", "8/12", "13/20", "20/40", "40/60", "60/80"],
  ...
  },
  {
    ...
    sizes:        ["U/5", "U/10", "10/20", "20/40", "40/60"],
    markets:      ["EU", "Far East", "US"],
  ...
  },
  {
    ...
    sizes:        ["U/3", "3/6", "6/10", "10/20", "20/40", "40/60"],
...
const shrimpProducts: CatalogProduct[] = [
  ...
  },
  {
    ...
    categoryId:   "shrimps",
    subcategory:  "Peeled & Deveined Shrimps",
    species:      "Solenocera crassicornis",
    presentation: "Raw",
    freezeType:   "IQF",
