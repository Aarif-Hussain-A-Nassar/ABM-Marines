      ...
      <div className="container-xl" style={{ position: "relative", zIndex: 2 }}>
        <div className="rg-split" style={{ alignItems: "center" }}>
          <div>
            ...
            <div className="rg-2" style={{ marginBottom: "2.5rem" }}>
              {pillars.slice(0, 2).map((p) => (
                <div key={p.title} style={{ padding: "1.5rem", background: "rgba(45, 212, 191, 0.05)", border: "1px solid rgba(45, 212, 191, 0.15)", borderRadius: "16px" }}>
            ...
            <Link href="/sustainability" className="btn-ghost" style={{ display: "inline-flex", textDecoration: "none", color: "var(--teal-300)", borderColor: "var(--teal-300)" }}>
          ...
          <div style={{ position: "relative", display: "flex", justifyContent: "center" }}>
            <div className="glass-card" style={{ padding: "2rem", textAlign: "center", border: "1px solid rgba(45, 212, 191, 0.3)", borderRadius: "30px", background: "rgba(45, 212, 191, 0.03)" }}>
              <div style={{ fontSize: "2.5rem", marginBottom: "0.5rem" }}>🌱</div>
              <h3 style={{ fontSize: "1.75rem", fontWeight: 800, color: "#fff", lineHeight: 1.2 }}>100% Traceable</h3>
              <p style={{ fontSize: "0.75rem", color: "var(--teal-300)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", marginTop: "0.25rem" }}>From Catch to Delivery</p>
            </div>
