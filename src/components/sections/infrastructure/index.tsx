  ...
  return (
    <section id="infrastructure" className="section-pad" style={{ background: "var(--ocean-900)", position: "relative", overflow: "hidden" }}>
      ...
      <div className="container-xl" style={{ position: "relative", zIndex: 2 }}>
        ...
        {/* Visit CTA — rg-cta */}
        <div className="rg-cta" style={{ marginTop: "4rem", padding: "2.5rem", background: "linear-gradient(135deg, rgba(34,211,238,0.06), rgba(45,212,191,0.04))", border: "1px solid rgba(34,211,238,0.12)", borderRadius: "20px" }}>
          <div>
          ...
          <button onClick={scrollToContact} className="btn-primary" style={{ flexShrink: 0 }}>Schedule a Visit</button>
        </div>
      </div>
    </section>
  );
