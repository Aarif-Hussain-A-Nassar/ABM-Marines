...
const expertiseItems = [
  ...
  },
  {
    ...
    desc: "Long-standing partnerships with local fishermen and suppliers ensure a steady raw material flow and the ability to meet large-scale demands without compromising quality.",
    color: "var(--cyan-400)",
  },
  {
    icon: (
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          inset: 0,
          backgroundImage:
            "radial-gradient(circle at 20% 50%, rgba(34,211,238,0.04) 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(45,212,191,0.04) 0%, transparent 50%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div className="container-xl" style={{ position: "relative", zIndex: 2 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          ...
          <p className="section-subheading" style={{ margin: "0 auto" }}>
            ...
            Over the years, we have built a reputation for precision, consistency,
            and trust in the global market.
          </p>
        </div>
      ...
      {/* Responsive */}
      <style>{`
        #expertise .cards-grid { position: relative; }
